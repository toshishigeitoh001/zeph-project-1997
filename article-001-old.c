...
hac hic scribere dicis:
initium simplex edito wo:
fingere suru:
hoc text agere structura esse:

english japanese latin german may be :) ...
and here edito and read eval print loop rel
describe to here hac hic ... :)

----- until here now ad2017 12 5 -----
am3:50
